 ...
 * Time: 13:17:50
 */
public class ArrayEditorV2 extends FieldEditor {
    ...
    public ArrayEditorV2(Object o, String fieldName, FieldMask mask, CompositeElement.Orientation orientation, char spaceChar, final StructuredEditorModel model) {
    ...
    /*private void addAddAction(VisibleElement arrayElement) {
        VisibleElementAction addArrayElementAction = new VisibleElementAction("Добавить элемент массива", "add.png", KeyStroke.getKeyStroke("ENTER")) { //TODO add normal text
            ...
            public void run(StructuredEditorModel model) {
                ...
                getModel().setFocusedElementAndCaret(getElement().getChild(selectIndex));
            }
        };
...
//            newIndex += 1 + length;
    ...
    private class InsertArrayElementAction extends VisibleElementAction {
        ...
        public void run(StructuredEditorModel model) {
            ...
            getModel().setFocusedElementAndCaret(getElement().getChild(index));
        }
    }
