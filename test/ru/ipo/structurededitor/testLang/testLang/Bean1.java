...
public class Bean1 implements DSLBean {
    ...
    public Cell getLayout() {
        return new Vert(
                ...
                new Horiz(new ConstantCell("Int Array Field 7: "), new ArrayFieldCell("field7", ArrayFieldCell.Orientation.Horizontal).withSpaceChar('+')),
                new Horiz(new ConstantCell("Enum Array Field 8: "), new ArrayFieldCell("field8", ArrayFieldCell.Orientation.Horizontal).withSpaceChar(',')),
                new Horiz(new ConstantCell("Double Array Field 9: "), new ArrayFieldCell("field9", ArrayFieldCell.Orientation.Horizontal)),
                new Horiz(new ConstantCell("Boolean Array Field 10: "), new ArrayFieldCell("field10", ArrayFieldCell.Orientation.Horizontal)),
                new Horiz(new ConstantCell("String Array Field 11: "), new ArrayFieldCell("field11", ArrayFieldCell.Orientation.Horizontal)),
                new Horiz(new ConstantCell("BeanA2 Array Field 12: "), new ArrayFieldCell("field12", ArrayFieldCell.Orientation.Horizontal)),
                new Horiz(new ConstantCell("Abstract BeanA Array Field 13: "), new ArrayFieldCell("field13", ArrayFieldCell.Orientation.Vertical))
        );
    }
